...
// https://github.com/mlarocca/AlgorithmsAndDataStructuresInAction/blob/master/JavaScript/src/dway_heap/dway_heap.js
...
class DWayHeap {
  ...
  peek(index) {
    ...
    return _elements.get(this)[index];
  }
...
for (let i = 0; i < 1000; i++) {
  ...
  heap.updatePriority(heap.peek(index), newValue);
}
